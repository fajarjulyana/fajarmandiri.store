...
# PyInstaller spec file for FajarMandiri Store v1.6.0
...
# Hidden imports untuk SocketIO dan dependencies v1.6.0
hidden_imports = [
...
# Data files yang perlu disertakan v1.6.0
datas = [
    ('templates', 'templates'),
    ('static', 'static'),
    ('fajarmandiri.db', '.'),
