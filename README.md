...
### ✨ **Fitur Baru Versi 1.5**

#### 🆕 **Yang Baru Ditambahkan**
- **💬 Sistem Chat Realtime**: Widget chat mengambang dengan Flask-SocketIO
- **👤 Admin Chat Management**: Dashboard admin untuk kelola semua percakapan
- **🔒 Security Enhancements**: Link admin disembunyikan dari footer publik
- **🐧 Linux Deployment**: Script otomatis untuk PyInstaller dan DEB package
- **📱 Mobile Chat Widget**: Optimasi chat untuk perangkat mobile
- **🔐 Admin Route Protection**: Route `/admin/` otomatis redirect ke login

#### 🛠️ **Perbaikan & Enhancement**
- **📞 Updated Contact Info**: Nomor telepon diperbarui ke +6281804411937
- **📅 Copyright Update**: Tahun diperbarui dari 2024 ke 2025
- **🎨 Template Storage**: Sistem copy template otomatis ke Documents
- **🔧 Build Scripts**: Script terpisah untuk Linux building dan packaging
